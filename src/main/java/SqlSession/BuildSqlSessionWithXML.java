...
public class BuildSqlSessionWithXML {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BuildSqlSessionWithXML.class);
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.info("SqlSessionFactory build successful.");
        } catch (IOException e) {
        ...
        try (SqlSession session = sqlSessionFactory.openSession()) {
            logger.info("SqlSession (XML config) opened successfully. Now testing connection...");
            ...
            logger.error("Error with SqlSession (XML config) or database query.", e);
        }
    }
}